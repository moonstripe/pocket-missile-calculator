...
export default function SimulationWrapper() {
    ...
    return (
        <div class="flex flex-col overflow-clip">
            <div class={`absolute top-0 left-0 bg-white w-screen h-screen flex flex-col ${modalVisibility} pt-32`}>
                ...
                <input type="text" class="mx-auto border my-2 rounded-lg w-1/2 px-4" placeholder="access code" name="access code" onInput={handleAccessCodeChange}/>
